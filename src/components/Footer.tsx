        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/artists" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  Featured Artists
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="text-base font-medium text-gray-900 mb-4">Resources</h4>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            <h4 className="text-base font-medium text-gray-900 mb-4">Join Our Community</h4>
            <p className="text-sm text-gray-600 mb-4">Follow us for updates on new artworks and upcoming auctions.</p>
            <div className="flex space-x-4">
              <a href="https://twitter.com/visauction" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900">
